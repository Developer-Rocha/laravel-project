...
/***/ "./resources/js/angular/controllers/taskController.js":
/*!************************************************************!*\
  !*** ./resources/js/angular/controllers/taskController.js ***!
  \************************************************************/
...
(function () {
  ...
  function TaskController($scope, $http) {
    ...
    taskCtrl.meunome = "Fabrício"; //functions
    ...
    function deleteProduto(index) {
      ...
      if (conf === true) {
        $http.delete('/task/' + taskCtrl.produtos[index].id).then(function (e) {
          if (e.data.Error) {
...
/***/ 3:
/*!******************************************************************!*\
  !*** multi ./resources/js/angular/controllers/taskController.js ***!
  \******************************************************************/
/*! no static exports found */
