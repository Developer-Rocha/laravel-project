...
/***/ "./resources/js/angular/mainController.js":
/*!************************************************!*\
  !*** ./resources/js/angular/mainController.js ***!
  \************************************************/
...
app.controller('TaskController', ['$scope', '$http', function ($scope, $http) {
  ...
  $scope.meunome = "Fabrício"; //functions
  ...
  function initTask() {
    $http.get('/task').then(function success(e) {
  ...
  function deleteProduto(index) {
    ...
    if (conf === true) {
      $http.delete('/task/' + $scope.produtos[index].id).then(function (e) {
        if (e.data.Error) {
...
/***/ 1:
/*!******************************************************!*\
  !*** multi ./resources/js/angular/mainController.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\inicioLaravel\blog\resources\js\angular\mainController.js */"./resources/js/angular/mainController.js");
